...
# Q1 : List the customers in the United States with a credit limit higher than \$1000.
select * from customers where country="USA" AND creditLimit>1000;

# Q2: List the employee codes for sales representatives of customers in Spain, France and Italy. 
#Make another query to list the names and email addresses of those employees.
select customerNumber,salesRepEmployeeNumber,country from customers where country="spain" or country="france" or country="Italy";
select firstname,lastname,email from employees where employeenumber in(1370,1337,1401,1702);

# Q3 : Change the job title "Sales Rep" to "Sales Representative"
...
delete from emoloyees where officecode=7; # WE CAN'T DELETE BECAUSE IN THE BACKEND THERE ARE SOME CONSTRAINTS ARE USE CONSTRAINTS==>RESTRICTIONS

# Q5 : Show a list of employees who are not sales representatives
select * from employees where jobtitle!="sales representative";

# Q6 : Show a list of customers with "Toys" in their name
Select customername from customers where customername like "%Toys%";

USE classicmodels;

# Q7 : LIST THE 5 MOST EXPENSIVE PRODUCTS FROM THE "PLANES" PRODUCTLINE
select productline,buyPrice from products where productLine="Planes" order by buyPrice desc limit 5;

# Q8 : IDENTIFY THE PRODUCTS THAT ARE ABOUT TO RUN OUT OF STOCK (QUANTITY IN STOCK<100)
